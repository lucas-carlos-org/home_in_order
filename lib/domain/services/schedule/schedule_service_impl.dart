...
class ScheduleServiceImpl implements IScheduleService{
  ...
  @override
  Future<void> createSchedule(String userId, ScheduleModel scheduleModel) => _scheduleRepository.createSchedule(userId, scheduleModel);
  
  @override
  Future<void> cancelSchedule(String userId, String documentId) => _scheduleRepository.cancelSchedule(userId, documentId);
